...
// Package gethclient provides an RPC client for infogeth-specific APIs.
package gethclient
...
// Client is a wrapper around rpc.Client that implements infogeth-specific functionality.
//
...
// GCStats retrieves the current garbage collection stats from a infogeth node.
...
// MemStats retrieves the current memory stats from a infogeth node.
...
// GetNodeInfo retrieves the node info of a infogeth node.
