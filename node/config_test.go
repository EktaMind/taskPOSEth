...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "infogeth.ipc", false, filepath.Join(os.TempDir(), "infogeth.ipc")},
		{"data", "infogeth.ipc", false, "data/infogeth.ipc"},
		{"data", "./infogeth.ipc", false, "./infogeth.ipc"},
		{"data", "/infogeth.ipc", false, "/infogeth.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "infogeth.ipc", true, `\\.\pipe\infogeth.ipc`},
		{"data", "infogeth.ipc", true, `\\.\pipe\infogeth.ipc`},
		{"data", `\\.\pipe\infogeth.ipc`, true, `\\.\pipe\infogeth.ipc`},
	}
