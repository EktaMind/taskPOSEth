...
// TestAttachWithHeaders tests that 'infogeth attach' with custom headers works, i.e
...
// TestAttachWithHeaders tests that 'infogeth db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
