...
func init() {
	// Run the app if we've been exec'd as "infogeth-test" in runGeth.
	reexec.Register("infogeth-test", func() {
...
// spawns infogeth with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "infogeth". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("infogeth-test", args...)
