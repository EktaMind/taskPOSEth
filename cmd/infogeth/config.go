...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "infogeth.ipc"
	return cfg
}

// makeConfigNode loads infogeth configuration and creates a blank node instance.
...
// makeFullNode loads infogeth configuration and creates the Ethereum backend.
