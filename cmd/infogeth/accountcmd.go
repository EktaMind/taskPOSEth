...
var (
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    infogeth wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
	infogeth wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    infogeth account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    infogeth account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    infogeth account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    infogeth account import [options] <keyfile>
