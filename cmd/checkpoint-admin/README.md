...
It is worth noting that checkpoint-admin only supports clef as a signer for transactions and plain text(checkpoint). For more clef usage, please see the clef [tutorial](https://infogeth.ethereum.org/docs/clef/tutorial) .
...
* Get your node configuration file `infogeth dumpconfig OTHER_COMMAND_LINE_OPTIONS > config.toml`
...
* Start infogeth with the modified configuration file
