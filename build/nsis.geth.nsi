...
# 1. install infogeth for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for infogeth
# 5. create infogeth, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since infogeth is installed global
